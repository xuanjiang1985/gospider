...
var start = 1
var end = 6
var url = "http://www.171english.cn/pep/xinqidian/4B/lesson"
var host = "http://www.171english.cn/pep/xinqidian/4B/"
func BookScrape() {

  for i := start; i <= end; i++ {
    fmt.Println("正在采集英语页面", i)

	resource := url + strconv.Itoa(i) + ".html"
    ...
    if err != nil {
	 ...
	 knowledgeName := knowledgeSlice[3]
